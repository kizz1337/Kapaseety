...
--
-- Client: 127.0.0.1
-- Généré le: Jeu 14 Août 2014 à 19:00
...
--
-- Doublure de structure pour la vue `clustes_hosts_vms`
--
CREATE TABLE IF NOT EXISTS `clustes_hosts_vms` (
`moref` varchar(50)
,`hostname` varchar(50)
,`cluster` varchar(50)
,`vm_num` int(10)
...
--
-- Structure de la vue `clustes_hosts_vms`
--
DROP TABLE IF EXISTS `clustes_hosts_vms`;
